...
const strConcat = function (myStr1, myStr2) {
  const firstStr = myStr1.substring(0, 2);
  const secondStr = myStr2.slice(-3);
  const output = (firstStr + secondStr).toUpperCase();
  console.log(output);
};

console.log(strConcat("ciao", "epicoders"));
